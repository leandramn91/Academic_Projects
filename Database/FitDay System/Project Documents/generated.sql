...
ALTER TABLE `Patient_Table` ADD  PRIMARY KEY (`PatientID`,`UserID`,`DeviceID`)
;
...
ALTER TABLE `PatientHistory_Table` ADD  PRIMARY KEY (`PatientHistoryID`,`PatientID`,`UserID`,`DeviceID`)
;
...
ALTER TABLE `DiabeticMeasure_Table` ADD  PRIMARY KEY (`PatientID`,`UserID`,`DeviceID`)
;
...
(
  ...
  `DoctorSystemSuggestion` Varchar(300),
  `PatientID` Int NOT NULL,
  `UserID` Int NOT NULL,
  `DeviceID` Smallint NOT NULL,
...
ALTER TABLE `Doctor_Table` ADD  PRIMARY KEY (`DoctorID`,`PatientID`,`UserID`,`DeviceID`,`ClinicID`)
;
...
ALTER TABLE `Treatment_Table` ADD  PRIMARY KEY (`TreatmentID`,`DoctorID`,`PatientID`,`UserID`,`DeviceID`,`ClinicID`)
;
...
ALTER TABLE `Doctor_Table` ADD CONSTRAINT `TreatedBy` FOREIGN KEY (`PatientID`, `UserID`, `DeviceID`) REFERENCES `Patient_Table` (`PatientID`, `UserID`, `DeviceID`) ON DELETE RESTRICT ON UPDATE RESTRICT
;

ALTER TABLE `DiabeticMeasure_Table` ADD CONSTRAINT `SampleMeasures` FOREIGN KEY (`PatientID`, `UserID`, `DeviceID`) REFERENCES `Patient_Table` (`PatientID`, `UserID`, `DeviceID`) ON DELETE RESTRICT ON UPDATE RESTRICT
;

ALTER TABLE `Treatment_Table` ADD CONSTRAINT `Suggests` FOREIGN KEY (`DoctorID`, `PatientID`, `UserID`, `DeviceID`, `ClinicID`) REFERENCES `Doctor_Table` (`DoctorID`, `PatientID`, `UserID`, `DeviceID`, `ClinicID`) ON DELETE RESTRICT ON UPDATE RESTRICT
;
...
ALTER TABLE `PatientHistory_Table` ADD CONSTRAINT `ArchievedIn` FOREIGN KEY (`PatientID`, `UserID`, `DeviceID`) REFERENCES `Patient_Table` (`PatientID`, `UserID`, `DeviceID`) ON DELETE RESTRICT ON UPDATE RESTRICT
;
